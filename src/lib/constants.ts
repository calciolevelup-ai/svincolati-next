...
export const SPORTS: Record<Sport, SportConfig> = {
  calcio: {
    nome: 'Calcio', icon: '⚽', color: '#41c285', foot: true, score: 'Reti', scoreOne: 'Rete', gk: 'Portiere', fed: 'FIGC',
  ...
  calcio5: {
    nome: 'Calcio a 5', icon: '🥅', color: '#38bdf8', foot: true, score: 'Reti', scoreOne: 'Rete', gk: 'Portiere', fed: 'FIGC',
  ...
  pallavolo: {
    nome: 'Pallavolo', icon: '🏐', color: '#c084fc', foot: false, score: 'Punti', scoreOne: 'Punto', gk: null, fed: 'FIPAV',
  ...
  rugby: {
    nome: 'Rugby', icon: '🏉', color: '#fbbf24', foot: false, score: 'Mete', scoreOne: 'Meta', gk: null, fed: 'FIR',
  ...
  basket: {
    nome: 'Basket', icon: '🏀', color: '#ff8c00', foot: false, score: 'Punti', scoreOne: 'Punto', gk: null, fed: 'FIP',
