    ...
    <div style={{minHeight:'100vh',background:'var(--bg)',display:'flex',flexDirection:'column'}}>
      ...
      <div style={{flex:1,display:'flex',alignItems:'stretch',position:'relative'}}>
        ...
        <div style={{flex:1,display:'flex',alignItems:'center',padding:'60px 24px',position:'relative',zIndex:2}}>
          <div style={{maxWidth:'480px'}}>
            ...
            <h1 style={{fontFamily:'Anton',fontWeight:400,fontSize:'clamp(44px,7vw,86px)',lineHeight:0.92,letterSpacing:'-.01em',textTransform:'uppercase',marginBottom:22,color:'var(--text)'}}>
              <span style={{color:'var(--text)'}}>Recupera il tuo</span><br/>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:12}}>
              <div style={{display:'flex',gap:12,alignItems:'flex-start'}}>
                ...
                <div>
                  <div style={{fontSize:15,color:'var(--text)'}}><b>Inserisci email</b> — l'indirizzo con cui sei registrato.</div>
                </div>
              </div>
              <div style={{display:'flex',gap:12,alignItems:'flex-start'}}>
                <span style={{color:'var(--acid)',fontWeight:800,flexShrink:0}}>02</span>
                <div>
                  <div style={{fontSize:15,color:'var(--text)'}}><b>Ricevi link</b> — controlla la tua casella postale.</div>
                </div>
              </div>
              <div style={{display:'flex',gap:12,alignItems:'flex-start'}}>
                <span style={{color:'var(--acid)',fontWeight:800,flexShrink:0}}>03</span>
                <div>
                  <div style={{fontSize:15,color:'var(--text)'}}><b>Reimposta password</b> — e accedi con la nuova.</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div style={{width:'400px',display:'flex',alignItems:'center',padding:'60px 24px',position:'relative',zIndex:3,background:'linear-gradient(135deg, transparent 0%, rgba(11,13,10,.3) 100%)'}}>
          <div style={{width:'100%'}}>
            <h2 style={{fontSize:16,fontWeight:'bold',color:'var(--text)',marginBottom:24,textAlign:'center'}}>Reset Password</h2>
            ...
            <form onSubmit={handleSubmit} style={{display:'flex',flexDirection:'column',gap:16}}>
              <div>
                ...
                <input
                  ...
                  required
                  style={{width:'100%',background:'var(--bg-2)',border:'1px solid var(--line)',color:'var(--text)',fontFamily:'Archivo',fontSize:'14.5px',padding:'12px 14px',borderRadius:10,outline:'none'}}
